...
export function RegisterPage() {
  ...
  return (
    <AuthCard
      title="Tạo tài khoản"
      description="Đăng ký tài khoản khách hàng HealthyHub."
      footer={
        <span>
    ...
    >
      {success ? (
        <>
          <StateIllustration src={authAssets.successIllustration} alt="Đăng ký thành công" />
        ...
        <AuthForm onSubmit={submit}>
          ...
          <p className="field-hint">
            Dùng 12–128 ký tự, không chứa email hoặc phần dễ đoán từ email và không sử dụng mật khẩu
            phổ biến.
          </p>
          <PasswordField
            id="confirmation"
