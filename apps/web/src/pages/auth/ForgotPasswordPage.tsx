...
export function ForgotPasswordPage() {
  ...
  return <AuthCard title="Quên mật khẩu" description="Nhập email để nhận hướng dẫn đặt lại mật khẩu." footer={<Link to="/login">Quay lại đăng nhập</Link>}>
    {accepted ? <FormAlert tone="success">Nếu email hợp lệ, bạn sẽ nhận được hướng dẫn đặt lại mật khẩu. Vui lòng kiểm tra hộp thư.</FormAlert> : <AuthForm onSubmit={submit}>
