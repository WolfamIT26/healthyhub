...
export function ResetPasswordPage() {
  ...
  if (!token)
    return (
      <AuthCard
        ...
        description="Liên kết đặt lại mật khẩu thiếu token hoặc đã bị thay đổi."
      >
        <StateIllustration
          src={authAssets.maintenanceIllustration}
          alt="Liên kết cần được làm mới"
        />
        <FormAlert>Vui lòng yêu cầu một liên kết đặt lại mật khẩu mới.</FormAlert>
  ...
  return (
    ...
    >
      {success ? (
        <>
          <StateIllustration src={authAssets.successIllustration} alt="Đổi mật khẩu thành công" />
          <FormAlert tone="success">
            Mật khẩu đã được thay đổi. Tất cả phiên cũ đã đăng xuất. Bạn có thể đăng nhập lại.
          </FormAlert>
        </>
      ) : (
        <AuthForm onSubmit={submit}>
          ...
          <p className="field-hint">
            Dùng 12–128 ký tự, không chứa thông tin email dễ đoán và không sử dụng mật khẩu phổ
            biến.
          </p>
          <PasswordField
            id="confirmation"
