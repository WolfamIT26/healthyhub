...
@Index('uq_cart_items_tenant_cart_product_status', ['tenantId', 'cartId', 'productId', 'itemStatus'], { unique: true })
...
export class CartItemEntity extends BaseAuditEntity {
  ...
  @Column({ name: 'item_price_snapshot', type: 'decimal', precision: 12, scale: 2, nullable: true }) itemPriceSnapshot!: null;
  @Column({ name: 'item_status', type: 'varchar', length: 32, default: 'active' }) itemStatus!: 'active' | 'unavailable' | 'removed';
