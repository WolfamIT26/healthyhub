...
export interface CartRepository {
  ...
  addOrMerge(customerProfileId: string, actorUserAccountId: string, productId: string, quantity: number, maximumQuantity: number): Promise<boolean>;
  updateQuantity(customerProfileId: string, actorUserAccountId: string, cartItemId: string, quantity: number): Promise<boolean>;
  remove(customerProfileId: string, actorUserAccountId: string, cartItemId: string): Promise<boolean>;
