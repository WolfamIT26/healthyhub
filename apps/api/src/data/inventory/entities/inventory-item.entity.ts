...
export class InventoryItemEntity extends BaseAuditEntity {
  ...
  @Column({ name: 'available_quantity', type: 'int', unsigned: true, default: 0 })
  availableQuantity!: number;
  @Column({ name: 'reserved_quantity', type: 'int', unsigned: true, default: 0 })
  reservedQuantity!: number;
  @Column({ name: 'stock_threshold', type: 'int', unsigned: true, default: 0 })
  stockThreshold!: number;
  @Column({ name: 'stock_status', type: 'varchar', length: 32, default: 'available' })
