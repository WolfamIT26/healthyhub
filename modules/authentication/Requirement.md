...
| AUTH-F02 | Đăng nhập bằng email và mật khẩu | Customer, Staff, Manager, Administrator | Tạo session và token nếu account hợp lệ |
...
| AUTH-F05 | Yêu cầu và hoàn tất reset password | Guest | Phản hồi generic; token một lần đổi password |
